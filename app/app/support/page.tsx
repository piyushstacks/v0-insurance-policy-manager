      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            ...
            <p className="font-medium text-slate-500">We're here to help you manage your policy engine.</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {supportCards.map((card) => (
            <div key={card.title} className="bg-white p-6 rounded-3xl border border-slate-200 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
