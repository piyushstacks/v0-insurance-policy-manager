...
export const styles = sortCx({
    ...
    colors: {
        ...
        "link-color": {
            root: [
                "justify-normal rounded p-0! text-blue-600 hover:text-blue-700",
                // Inner text underline
                "*:data-text:underline *:data-text:decoration-transparent hover:*:data-text:decoration-current",
                // Icon styles
                "*:data-icon:text-blue-600 hover:*:data-icon:text-blue-700",
            ].join(" "),
        },
        "link-gray": {
            root: [
        ...
        "primary-destructive": {
            root: [
                "bg-red-600 text-white shadow-sm ring-1 ring-transparent outline-red-600 ring-inset hover:bg-red-700 data-loading:bg-red-700",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Icon styles
                "*:data-icon:text-white/60 hover:*:data-icon:text-white/70",
        ...
        "tertiary-destructive": {
            root: [
                "text-red-600 outline-red-600 hover:bg-red-50 hover:text-red-700 data-loading:bg-red-50",
                // Icon styles
                "*:data-icon:text-red-600 hover:*:data-icon:text-red-700",
            ].join(" "),
        },
        "link-destructive": {
            root: [
                "justify-normal rounded p-0! text-red-600 outline-red-600 hover:text-red-700",
                // Inner text underline
